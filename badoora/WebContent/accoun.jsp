...
String address = request.getParameter("formtext6");
String gender = request.getParameter("formselect1");
String country = request.getParameter("formselect2");
String postal = request.getParameter("formtext7");
String ccard = request.getParameter("formselect3");
String cnum = request.getParameter("formtext8");
String see = request.getParameter("formtext9");
String vnum = request.getParameter("formtext10");
if("create".equals(action)){
	int se = Integer.parseInt(see);
ap app = new ap(lname,fname,email,password,address,gender,postal,country,ccard,cnum,se,vnum);
...
<input name="formtext4" type="password" style="position:absolute;width:200px;left:329px;top:415px;z-index:19">
...
<div id="text16" style="position:absolute; overflow:hidden; left:459px; top:685px; width:214px; height:32px; z-index:36">
<div class="wpmd">
...
<div id="image1" style="position:absolute; overflow:hidden; left:486px; top:109px; width:56px; height:39px; z-index:39"><img src="images/6.JPG" alt="" title="" border=0 width=56 height=39> data-toggle="modal" data-target="#myModal"</div>
...
<td><button name="action" type="button" class="btn" value="create" style="position:absolute;left:315px;top:741px;z-index:43">
</button>
</td>
<input name="formbutton2" type="button" value="Cancel" style="position:absolute;left:405px;top:741px;z-index:44">
<td> <button class="btn" name = "action" value="create" onclick="confirmation()"  style="position:absolute;left:315px;top:741px;z-index:43" >
Register
</button>
</td>
